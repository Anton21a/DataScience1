...
|----------|-------|-----------|---|-----|---------------|--------------|----------------|
| Intercept | 2.849 | 0.055 | 52.13 | 0.000 | 2.742 | 2.956 | Baseline predicted happiness (ref. categories) |
...
| Satisfaction = 10 | -1.307 | 0.058 | -22.37 | 0.000 | -1.421 | -1.192 | Strongest effect: very satisfied → much happier |
| **Gender (ref = Male)** ||||||||
